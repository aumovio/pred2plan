...
#from predictor.models.mtr.ops import attention
import predictor.models.mtr.ops.attention.non_cuda as attention 
...
class MultiheadAttentionLocal(nn.Module):
    ...
    def forward(
        ...
        attn_output_weights = attention.attention_weight_computation(
            query_batch_cnt, key_batch_cnt, index_pair_batch, index_pair,
            q, k
        )
        ...
        if ctx_rpe_value is not None:
            ...
            attn_output = attention.attention_value_computation(
                    query_batch_cnt, key_batch_cnt, index_pair_batch, index_pair,
                    attn_output_weights, v
                )
