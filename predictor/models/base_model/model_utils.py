...
def wasserstein_distance_pairwise(params):
    """
    ...
    # Extract parameters
    mu = params[..., :2]                           # [B, G, 2]
    sigma_x = params[..., 2]                       # [B, G]
    sigma_y = params[..., 3]                       # [B, G]
    rho = params[..., 4]                           # [B, G]
    ...
    def sqrtm_psd(mat):
        ...
        return (eigvecs * eigvals_clamped.unsqueeze(-2)) @ eigvecs.transpose(-2, -1)
